...
int cfw_strcmp(char* s1, char*s2, unsigned int size, unsigned int w1, unsigned int w2);    // w1 = size of string1 letters
void cfw_strcpy(char* dest, char* source, unsigned int size, unsigned int w1, unsigned int w2);
void cfw_hextostr(unsigned int num, char* str);
